...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        Companion babs = new Companion ("Barbara", "Wright", "", "1963 – 1965",
                "Jacqueline Hill", "A History teacher with a strong moral conviction.");
        companionRepository.save(babs);

        Companion ian = new Companion ("Ian", "Chesterton", "", "1963 – 1965", "William Russell", "A Chemistry teacher turned action hero.");
        companionRepository.save(ian);

        Companion vicki = new Companion ("Vicki", "", "", "1965", "Maureen O’Brien", "A child of the future, full of vim and vitality.");
        companionRepository.save(vicki);

        Companion steven = new Companion ("Steven", "Taylor", "", "1965 – 1966", "Peter Purves", "A strong-willed astronaut from the future.");
        companionRepository.save(steven);

        Companion katarina = new Companion ("Katarina", "", "", "1965", "Adrienne Hill", "A handmaiden from Ancient Troy.");
        companionRepository.save(katarina);

        Companion saraK = new Companion ("Sara", "Kingdom", "", "1965 – 1966", "Jean Marsh", "A high calibre Space Security Agent.");
        companionRepository.save(saraK);

        Companion dodo = new Companion ("Dorothea", "Chaplet", "Dodo", "1966", "Jackie Lane", "A happy go-lucky Sixties teenager.");
        companionRepository.save(dodo);

        Companion ben = new Companion ("Ben", "Jackson", "", "Michael Craze", "1966 – 1967", "A Royal Navy Able Seaman, very protective of Polly.");
        companionRepository.save(ben);

        Companion polly = new Companion ("Polly", "", "", "Anneke Wills", "1966 – 1967", "A sophisticated young woman from the Sixties.");
        companionRepository.save(polly);

        Companion jamie = new Companion ("Jamie", "McCrimmon", "", "1966 – 1969",
                "Frazer Hines", "A strong and loyal friend who the Doctor meets after the Battle of Culloden.");
        companionRepository.save(jamie);

        Companion victoria = new Companion ("Victoria", "Waterfield", "", "1967 – 1968",
                "Deborah Watling", "A Victorian orphan who struggles with life on board the TARDIS.");
        companionRepository.save(victoria);

        Companion zoe = new Companion ("Zoe", "Heriot", "", "1968 – 1969", "Wendy Padbury", "A genius astrophysicist who has trouble connecting to other people.");
        companionRepository.save(zoe);

        Companion brigadier = new Companion ("Alastair Gordon", "Lethbridge-Stewart",
                "The Brigadier", "1970 – 1975", "Nicholas Courtney", "A soldier, sometime antagonist and ultimately long term friend of the Doctor.");
        companionRepository.save(brigadier);

        Companion liz = new Companion ("Liz", "Shaw", "", "1970", "Caroline John", "A Cambridge Scientist seconded to UNIT.");
        companionRepository.save(liz);

        Companion benton = new Companion ("John", "Benton", "Sergeant Benton", "1970 – 1975", "John Levene", "A loyal, sturdy soldier.");
        companionRepository.save(benton);

        Companion jo = new Companion ("Jo", "Grant", "", "1971 – 1973", "Katy Manning",
                "A ditz with a heart of gold, who grows more and more capable.");
        companionRepository.save(jo);

        Companion yates = new Companion ("Mike", "Yates", "Captain Yates", "1971 – 1974", "Richard Franklin", "A UNIT captain who manages to last more than one story.");
        ...
        Companion harry = new Companion ("Harry", "Sullivan", "", "1974 – 1975", "Ian Marter", "A Naval surgeon. Nice but occasionally clumsy in a well-meaning way.");
        companionRepository.save(harry);

        Companion leela = new Companion ("Leela", "", "", "1977 – 1978", "Louise Jameson", "A warrior of the Sevateem Tribe, smart and capable.");
        companionRepository.save(leela);

        Companion k9 = new Companion ("K9", "", "", "1977 – 1981", "John Leeson/David Brierly", "A prissy robot dog who is as loyal as he is prissy.");
        companionRepository.save(k9);

        Companion romanaOne = new Companion ("Romana", "", "Romana I", "1978 – 1979", "Mary Tamm", "An intelligent but naive Time Lord Academy graduate.");
        companionRepository.save(romanaOne);

        Companion romanaTwo = new Companion ("Romana", "", "Romana II", "1979 – 1981", "Lalla Ward", "A more experienced traveller than her first incarnation.");
        companionRepository.save(romanaTwo);

        Companion adric = new Companion ("Adric", "", "", "1980 – 1982", "Matthew Waterhouse", "An awkward maths genius, means well but tries people's patience.");
        ...
        Companion nyssa = new Companion ("Nyssa", "", "", "1981 – 1983", "Sarah Sutton",
                "A princess of Traken. Capable and caring but lowkey.");
        companionRepository.save(nyssa);

        Companion turlough = new Companion ("Vislor", "Turlough", "Turlough", "1983 – 1984", "Mark Strickson", "A hard-to-trust alien trapped in an English public school.");
        companionRepository.save(turlough);

        Companion kamelion = new Companion("Kamelion", "", "", "1983 – 1984", "Gerald Flood (voice)", "A shape-shifting android.");
        companionRepository.save(kamelion);

        Companion peri = new Companion ("Peri", "Brown", "", "1984 – 1986", "Nicola Bryant", "A young American botany student who has a genuinely terrible time.");
        ...
        Companion grace = new Companion ("Grace", "Holloway", "", "1996", "Daphne Ashbrook", "A surgeon who accidentally kills the Doctor.");
        ...
        Story unearthly = new Story
                ("An Unearthly Child",
                        ...
                        "images/hartnell_troughton_logo.png",
        ...
        Story invasionDinosaurs = new Story(
                ...
                "images/pertwee_t_baker_logo.png",
        ...
        Story leisureHive = new Story(
                ...
                "images/t_baker_davison_logo.png",
